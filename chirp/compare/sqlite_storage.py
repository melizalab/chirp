...
CREATE TABLE %s (
`id` INTEGER NOT NULL,
`ref` INTEGER NOT NULL REFERENCES %s(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
`tgt` INTEGER NOT NULL REFERENCES %s(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
%s,
